...
Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit
 lobortis nisl ut ali...">
    <meta property="og:image"
          content="http://cdn.simplesite.com/i/d2/f3/285415634679428050/i285415639381953180._szw1280h1280_.jpg">
    ...
    <link rel="stylesheet" type="text/css" href="/resources/How to Help_files/9767413.design.v27169.css">
    ...
    <script type="text/javascript" async="" src="/resources/How to Help_files/analytics.js.download"></script>
    <script async="" src="/resources/How to Help_files/gtm.js.download"></script>
    <script type="text/javascript" src="/resources/How to Help_files/FrontendAppLocalePage.aspx"></script>
...
<div class="container-fluid site-wrapper"> <!-- this is the Sheet -->
            ...
            <div class="row-fluid content-inner">
                <div id="left" class="span9"> <!-- ADD "span12" if no sidebar, or "span9" with sidebar -->
                    <div class="wrapper contact">
                        ...
                        <div class="content">
                            <c:forEach items="${Help}" var="entry">
                                ${entry}
                            </c:forEach>
    ...
    <li><a id="share-facebook" href="http://us-123charity.simplesite.com/422328015#"><i
            class="icon-facebook-sign"></i><span>Share on Facebook</span></a></li>
    <li><a id="share-twitter" href="http://us-123charity.simplesite.com/422328015#"><i
            class="icon-twitter-sign"></i><span>Share on Twitter</span></a></li>
    <li><a id="share-google-plus" href="http://us-123charity.simplesite.com/422328015#"><i
            class="icon-google-plus-sign"></i><span>Share on Google+</span></a></li>
                        ...
                        <div class="wrapper viral-box">
                            ...
                            <div class="content">
                                ...
                                <div class="bottom">
                                    <a rel="nofollow"
                                       href="http://www.simplesite.com/pages/receive.aspx?partnerkey=123i%3arightbanner&amp;referercustomerid=15831186&amp;refererpageid=422328015"
        ...
        <div class="container">
            <div class="footer-info">
                ...
                <div class="footer-powered-by">
                    <a rel="nofollow"
                       href="http://www.simplesite.com/pages/receive.aspx?partnerkey=123i%3afooterbanner&amp;referercustomerid=15831186&amp;refererpageid=422328015">Get
