...
<head>
    ...
    <meta property="og:image"
          content="http://maps.googleapis.com/maps/api/staticmap?center=56.26392%2c9.50178500000004&amp;zoom=6&amp;size=1200x630&amp;maptype=roadmap&amp;sensor=false&amp;markers=56.26392%2c9.50178500000004">
    ...
    <link rel="apple-touch-icon" sizes="114x114"
          href="http://us-123charity.simplesite.com/apple-touch-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120"
          href="http://us-123charity.simplesite.com/apple-touch-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144"
          href="http://us-123charity.simplesite.com/apple-touch-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152"
          href="http://us-123charity.simplesite.com/apple-touch-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180"
          href="http://us-123charity.simplesite.com/apple-touch-icon-180x180.png">
...
<div class="container-fluid site-wrapper"> <!-- this is the Sheet -->
                ...
                <div id="left" class="span9"> <!-- ADD "span12" if no sidebar, or "span9" with sidebar -->
                    <div class="wrapper map-page">
                        ...
                        <div class="content">
                            <div class="section">
                                <div class="content">
                                    <c:forEach var="entry" items="${Contact}">
                                        ${entry}
                                    </c:forEach>
                                </div>
                            </div>
                            <div class="section">
                                <div class="content">
                                    <div class="map-container">
                                        <div id="mapCanvas" data-ss="map" class="google-map" data-zoom="6"
                                             data-lat="56.26392" data-lng="9.50178500000004" data-maptype="roadmap"
                                             data-bubbletext="" data-showbubble="True" data-culture="en-US"
                                            ...
                                            <div style="height: 100%; width: 100%; position: absolute; background-color: rgb(229, 227, 223);">
                                                <div class="gm-style"
                                                        ...
                                                        <div style="position: absolute; left: 0px; top: 0px; z-index: 1; width: 100%; transform-origin: 0px 0px 0px; transform: matrix(1, 0, 0, 1, 0, 0);">
                                                            <div style="position: absolute; left: 0px; top: 0px; z-index: 100; width: 100%;">
                                                                <div style="position: absolute; left: 0px; top: 0px; z-index: 0;">
                                                                    <div aria-hidden="true"
                                                                        ...
                                                                        <div style="width: 256px; height: 256px; position: absolute; left: 174px; top: 40px;"></div>
                                                                        <div style="width: 256px; height: 256px; position: absolute; left: 430px; top: 40px;"></div>
                                                                        <div style="width: 256px; height: 256px; position: absolute; left: 430px; top: -216px;"></div>
                                                                        <div style="width: 256px; height: 256px; position: absolute; left: 174px; top: -216px;"></div>
                                                                        <div style="width: 256px; height: 256px; position: absolute; left: 174px; top: 296px;"></div>
                                                                        <div style="width: 256px; height: 256px; position: absolute; left: 430px; top: 296px;"></div>
                                                                        <div style="width: 256px; height: 256px; position: absolute; left: -82px; top: 40px;"></div>
                                                                        <div style="width: 256px; height: 256px; position: absolute; left: 686px; top: 40px;"></div>
                                                                        <div style="width: 256px; height: 256px; position: absolute; left: -82px; top: 296px;"></div>
                                                                        <div style="width: 256px; height: 256px; position: absolute; left: 686px; top: -216px;"></div>
                                                                        <div style="width: 256px; height: 256px; position: absolute; left: -82px; top: -216px;"></div>
                                                                        <div style="width: 256px; height: 256px; position: absolute; left: 686px; top: 296px;"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div style="position: absolute; left: 0px; top: 0px; z-index: 103; width: 100%;">
                                                                <div style="position: absolute; left: 0px; top: 0px; z-index: -1;">
                                                                    <div aria-hidden="true"
                                                                         style="position: absolute; left: 0px; top: 0px; z-index: 1; visibility: inherit;">
                                                                        <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: 174px; top: 40px;">
                                                                        ...
                                                                        <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: 430px; top: 40px;"></div>
                                                                        <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: 430px; top: -216px;"></div>
                                                                        <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: 174px; top: -216px;"></div>
                                                                        <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: 174px; top: 296px;"></div>
                                                                        <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: 430px; top: 296px;"></div>
                                                                        <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: -82px; top: 40px;"></div>
                                                                        <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: 686px; top: 40px;"></div>
                                                                        <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: -82px; top: 296px;"></div>
                                                                        <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: 686px; top: -216px;"></div>
                                                                        <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: -82px; top: -216px;"></div>
                                                                        <div style="width: 256px; height: 256px; overflow: hidden; position: absolute; left: 686px; top: 296px;"></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div style="margin-left: 5px; margin-right: 5px; z-index: 1000000; position: absolute; left: 0px; bottom: 0px;">
                                                        <a target="_blank"
                                                           href="https://maps.google.com/maps?ll=56.26392,9.501785&amp;z=6&amp;t=m&amp;hl=en-US&amp;gl=US&amp;mapclient=apiv3"
                                                    ...
                                                    <div style="background-color: white; padding: 15px 21px; border: 1px solid rgb(171, 171, 171); font-family: Roboto, Arial, sans-serif; color: rgb(34, 34, 34); box-shadow: rgba(0, 0, 0, 0.2) 0px 4px 16px; z-index: 10000002; display: none; width: 256px; height: 148px; position: absolute; left: 200px; top: 166px;">
                                                        <div style="padding: 0px 0px 10px; font-size: 16px;">Map Data
                                                        </div>
                                                        <div style="font-size: 13px;">Map data ©2017 GeoBasis-DE/BKG
                                                            (©2009), Google
                                                        </div>
                                                    ...
                                                    <div class="gmnoprint"
                                                         style="z-index: 1000001; position: absolute; right: 71px; bottom: 0px; width: 245px;">
                                                        <div draggable="false" class="gm-style-cc"
                                                            ...
                                                            <div style="position: relative; padding-right: 6px; padding-left: 6px; font-family: Roboto, Arial, sans-serif; font-size: 10px; color: rgb(68, 68, 68); white-space: nowrap; direction: ltr; text-align: right; vertical-align: middle; display: inline-block;">
                                                                <a style="color: rgb(68, 68, 68); text-decoration: none; cursor: pointer; display: none;">Map
                                                                    Data</a><span>Map data ©2017 GeoBasis-DE/BKG (©2009), Google</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div draggable="false" class="gm-style-cc"
                                                        ...
                                                        <div style="position: relative; padding-right: 6px; padding-left: 6px; font-family: Roboto, Arial, sans-serif; font-size: 10px; color: rgb(68, 68, 68); white-space: nowrap; direction: ltr; text-align: right; vertical-align: middle; display: inline-block;">
                                                            <a target="_new"
                                                               ...
                                                               href="https://www.google.com/maps/@56.26392,9.501785,6z/data=!10m1!1e1!12b1?source=apiv3&amp;rapsrc=apiv3"
                                                    ...
                                                    <div class="gmnoprint"
                                                        ...
                                                        <div class="gm-style-mtc" style="float: left;">
                                                            ...
                                                            <div style="background-color: white; z-index: -1; padding: 2px; border-bottom-left-radius: 2px; border-bottom-right-radius: 2px; box-shadow: rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px; position: absolute; left: 0px; top: 38px; text-align: left; display: none;">
                                                                <div draggable="false"
                                                        ...
                                                        <div class="gm-style-mtc" style="float: left;">
                                                            <div draggable="false" title="Show satellite imagery"
                                                                 style="direction: ltr; overflow: hidden; text-align: center; position: relative; color: rgb(86, 86, 86); font-family: Roboto, Arial, sans-serif; user-select: none; font-size: 11px; background-color: rgb(255, 255, 255); padding: 8px; border-bottom-right-radius: 2px; border-top-right-radius: 2px; -webkit-background-clip: padding-box; background-clip: padding-box; box-shadow: rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px; border-left: 0px; min-width: 37px;">
                                                                Satellite
                                                            </div>
                                                            <div style="background-color: white; z-index: -1; padding: 2px; border-bottom-left-radius: 2px; border-bottom-right-radius: 2px; box-shadow: rgba(0, 0, 0, 0.298039) 0px 1px 4px -1px; position: absolute; right: 0px; top: 38px; text-align: left; display: none;">
                                                                <div draggable="false"
    ...
    <li><a id="share-facebook" href="http://us-123charity.simplesite.com/422328016#"><i
            class="icon-facebook-sign"></i><span>Share on Facebook</span></a></li>
    <li><a id="share-twitter" href="http://us-123charity.simplesite.com/422328016#"><i
            class="icon-twitter-sign"></i><span>Share on Twitter</span></a></li>
    <li><a id="share-google-plus" href="http://us-123charity.simplesite.com/422328016#"><i
            class="icon-google-plus-sign"></i><span>Share on Google+</span></a></li>
                        ...
                        <div class="wrapper viral-box">
                            ...
                            <div class="content">
                                ...
                                <div class="bottom">
                                    <a rel="nofollow"
                                       href="http://www.simplesite.com/pages/receive.aspx?partnerkey=123i%3arightbanner&amp;referercustomerid=15831186&amp;refererpageid=422328016"
        ...
        <div class="container">
            <div class="footer-info">
                ...
                <div class="footer-powered-by">
                    <a rel="nofollow"
                       href="http://www.simplesite.com/pages/receive.aspx?partnerkey=123i%3afooterbanner&amp;referercustomerid=15831186&amp;refererpageid=422328016">Get
                        Your own FREE website. Click here!</a>
                </div>
            </div>
            <div class="footer-page-counter" style="display: block;">
                <fmt:formatNumber var="number" value="${Counter}" pattern="0,0,0,0,0,0"/>
                <c:forTokens items="${number}" delims="," var="splitNum">
                    <span class="footer-page-counter-item"><c:out value="${splitNum}"/></span>
                </c:forTokens>
            </div>
